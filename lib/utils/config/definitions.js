...
define('rosette', {
  ...
  type: Boolean,
  description: `
    Cool stuff happens when you turn on this flag.
  `,
  flatten,
})
...
define('consistency', {
  ...
  type: String,
  description: `
    Consistency predicate when solving. Options: npm, pip, cargo, pip-else-npm.
  `,
  flatten,
})

define('minimize', {
  default: "min_oldness,min_num_deps",
  type: String,
  description: `
    Minimization criteria. Must be of the form: [goal] , ...\n
    where [goal] is of the form: [term] + ...\n
    where [term] is of the form: [objective_name] | coefficient * [objective_name]
    where [objective_name] is of the form: min_num_deps | min_oldness | min_duplicates
  `,
  flatten,
})
...
define('disallow-cycles', {
  ...
  type: Boolean,
  description: `
    Tell MinNPM to disallow cycles in the dependency graph.
  `,
  flatten,
})

define('rosette-only-explore', {
  default: false,
  type: Boolean,
  description: `
    Cool stuff happens when you turn on this flag.
...
define('re-solve-with-npm', {
  default: false,
  type: Boolean,
  description: `
    If this is turned on, then solve first with Rosette, then with npm.
  `,
  flatten,
})
...
define('solve-fresh', {
  default: true,
  type: Boolean,
  usage: '--no-solve-fresh',
  description: `
    If this is turned on, then before solving anything, nuke the node_modules/ and package-lock.json.
  `,
  flatten,
})
